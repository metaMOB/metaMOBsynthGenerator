...
/**
 * This is the item provider adapter for a {@link uid.Notification} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class NotificationItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 UidPackage.Literals.NOTIFICATION__NAME,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((uid.Notification)object).getName();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(uid.Notification.class)) {
