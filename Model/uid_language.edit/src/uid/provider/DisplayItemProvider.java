...
/**
 * This is the item provider adapter for a {@link uid.Display} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Display_image_background_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Display_image_background_feature", "_UI_Display_type"),
				 UidPackage.Literals.DISPLAY__IMAGE_BACKGROUND,
				 true,
				 false,
				 false,
	...
	protected void addValuePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Display_value_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Display_value_feature", "_UI_Display_type"),
				 UidPackage.Literals.DISPLAY__VALUE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
