...
/**
 * This is the item provider adapter for a {@link uid.Stage} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class StageItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Stage_background_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Stage_background_feature", "_UI_Stage_type"),
				 UidPackage.Literals.STAGE__BACKGROUND,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 UidPackage.Literals.STAGE__NAME,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(UidPackage.Literals.STAGE__HAS_DISPLAY);
			childrenFeatures.add(UidPackage.Literals.STAGE__HAS_CONTAINER);
			childrenFeatures.add(UidPackage.Literals.STAGE__HAS_MATRIX);
			childrenFeatures.add(UidPackage.Literals.STAGE__HAS_REGULATOR);
			childrenFeatures.add(UidPackage.Literals.STAGE__HAS_BUTTON);
			childrenFeatures.add(UidPackage.Literals.STAGE__HAS_SWITCH);
			childrenFeatures.add(UidPackage.Literals.STAGE__HAS_EVENTS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(UidPackage.Literals.STAGE__HAS_DISPLAY,
				 UidFactory.eINSTANCE.createDisplay()));

		newChildDescriptors.add
			(createChildParameter
				(UidPackage.Literals.STAGE__HAS_CONTAINER,
				 UidFactory.eINSTANCE.createContainer()));

		newChildDescriptors.add
			(createChildParameter
				(UidPackage.Literals.STAGE__HAS_MATRIX,
				 UidFactory.eINSTANCE.createMatrix()));

		newChildDescriptors.add
			(createChildParameter
				(UidPackage.Literals.STAGE__HAS_REGULATOR,
				 UidFactory.eINSTANCE.createRegulator()));

		newChildDescriptors.add
			(createChildParameter
				(UidPackage.Literals.STAGE__HAS_BUTTON,
		...
		newChildDescriptors.add
			(createChildParameter
				(UidPackage.Literals.STAGE__HAS_SWITCH,
				 UidFactory.eINSTANCE.createSwitch()));

		newChildDescriptors.add
			(createChildParameter
				(UidPackage.Literals.STAGE__HAS_EVENTS,
				 UidFactory.eINSTANCE.createEvent()));
	}
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
		...
		boolean qualify =
			childFeature == UidPackage.Literals.STAGE__HAS_BUTTON ||
			childFeature == UidPackage.Literals.STAGE__HAS_SWITCH;
