...
/**
 * This is the item provider adapter for a {@link uid.Command} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 UidPackage.Literals.COMMAND__NAME,
				 true,
				 false,
				 false,
	...
	protected void addHasNotificationPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Command_hasNotification_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Command_hasNotification_feature", "_UI_Command_type"),
				 UidPackage.Literals.COMMAND__HAS_NOTIFICATION,
				 true,
				 false,
				 true,
				 null,
