 ...
 * <ul>
 *   <li>{@link uid.impl.CommandImpl#getName <em>Name</em>}</li>
 *   <li>{@link uid.impl.CommandImpl#getHasNotification <em>Has Notification</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CommandImpl extends EObjectImpl implements Command {
	...
	protected EClass eStaticClass() {
		return UidPackage.Literals.COMMAND;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, org.eclipse.emf.common.notify.Notification.SET, UidPackage.COMMAND__NAME, oldName, name));
	}
	...
	public EList<Notification> getHasNotification() {
		if (hasNotification == null) {
			hasNotification = new EObjectResolvingEList<Notification>(Notification.class, this, UidPackage.COMMAND__HAS_NOTIFICATION);
		}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case UidPackage.COMMAND__NAME:
				return getName();
			case UidPackage.COMMAND__HAS_NOTIFICATION:
