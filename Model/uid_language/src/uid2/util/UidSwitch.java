...
public class UidSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case UidPackage.ENTITY_TRANSITION: {
				EntityTransition entityTransition = (EntityTransition)theEObject;
				T result = caseEntityTransition(entityTransition);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case UidPackage.APPLICATION: {
			...
			case UidPackage.HALLO: {
				hallo hallo = (hallo)theEObject;
				T result = casehallo(hallo);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Entity Transition</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Entity Transition</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseEntityTransition(EntityTransition object) {
		return null;
	}
	 ...
	 * @generated
	 */
	public T caseSwitch(uid.Switch object) {
		return null;
	}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>hallo</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>hallo</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T casehallo(hallo object) {
		return null;
	}
